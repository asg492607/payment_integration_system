...
/** Plans configuration — customize these for your startup */
const PLANS = {
  starter: { label: 'Starter',  amount: 199, duration: '30 Days' },
  pro:     { label: 'Pro',      amount: 499, duration: '90 Days' },
  empire:  { label: 'Empire',   amount: 999, duration: '365 Days' },
};
